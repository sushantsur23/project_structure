...
touch ${project_name_}_Notebooks/test1.ipynb
touch ${project_name_}_Notebooks/test2.ipynb
touch ${project_name_}_Notebooks/test3.ipynb
...
pip_requirements numpy pandas seaborn sklearn streamlit nltk notebook ipykernel PyYAML fastapi 
